...
export const traductions = {
  fr: {
    ...
    cniObligatoire: 'Numéro de la carte d\'identité (CNI) *',
    recto: 'Recto',
    verso: 'Verso',
    prendrePhoto: 'Prendre photo',
    scannerPDF: 'Scanner / PDF',
    inscriptionSecurisee: 'Inscription sécurisée',
    descInscription: 'Le numéro de votre CNI est requis pour garantir l\'authenticité de vos demandes administratives.',
    cniRecto: 'Numéro CNI requis',
  ...
  en: {
    ...
    cniObligatoire: 'National Identity Card number (NIC) *',
    recto: 'Front',
    verso: 'Back',
    prendrePhoto: 'Take photo',
    scannerPDF: 'Scan / PDF',
    inscriptionSecurisee: 'Secure registration',
    descInscription: 'Your NIC number is required to guarantee the authenticity of your administrative requests.',
    cniRecto: 'NIC number required',
